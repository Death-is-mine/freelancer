...
describe('toPublicView', () => {
  it('returns public view with only approved fields', () => {
    ...
    expect(Object.keys(view.project)).toEqual([
      'id',
      'client',
      'requirement',
      'amount',
