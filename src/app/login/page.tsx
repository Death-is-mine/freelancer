    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="w-full max-w-md mx-auto px-6">
        <div className="text-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-primary-container flex items-center justify-center mx-auto mb-6" aria-hidden="true">
        ...
        <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 shadow-sm p-8">
          ...
          <p className="text-body-md text-on-surface-variant mb-8">Sign in with your Google account to continue.</p>

          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="w-full py-3.5 rounded-xl bg-primary text-on-primary font-semibold text-body-md hover:opacity-95 transition-opacity shadow-lg shadow-primary/10 flex items-center justify-center gap-3"
          ...
          <p className="text-label-sm text-on-surface-variant/80 text-center mt-6">
