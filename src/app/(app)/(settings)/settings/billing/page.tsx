...
export default function BillingPage() {
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-body-md text-on-surface-variant mb-8">Manage your subscription and billing information.</p>
      <div className="bg-surface-container-lowest p-6 rounded-2xl border border-outline-variant/20 space-y-6">
        ...
        <p className="text-body-md text-on-surface-variant">No payment methods on file. Billing will be available in a future update.</p>
      </div>
    </div>
  )
}
