      ...
      {editing && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative bg-surface-container-lowest w-full max-w-lg rounded-2xl border border-outline-variant/10 shadow-2xl p-6 z-10" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              <input placeholder="Client name" aria-label="Client name" value={edit.client} onChange={(e) => setEdit({ ...edit, client: e.target.value })} className="w-full bg-surface-container-high border-none rounded-lg px-4 py-2.5 text-body-md outline-none focus:ring-2 focus:ring-primary/20" />
              <input placeholder="Requirement / Project name" aria-label="Project name" value={edit.requirement} onChange={(e) => setEdit({ ...edit, requirement: e.target.value })} className="w-full bg-surface-container-high border-none rounded-lg px-4 py-2.5 text-body-md outline-none focus:ring-2 focus:ring-primary/20" />
              <input placeholder="Amount ($)" aria-label="Amount" value={edit.amount} onChange={(e) => setEdit({ ...edit, amount: e.target.value })} className="w-full bg-surface-container-high border-none rounded-lg px-4 py-2.5 text-body-md outline-none focus:ring-2 focus:ring-primary/20" />
              <input placeholder="Due date (e.g. Aug 15, 2026)" aria-label="Due date" value={edit.dueDate} onChange={(e) => setEdit({ ...edit, dueDate: e.target.value })} className="w-full bg-surface-container-high border-none rounded-lg px-4 py-2.5 text-body-md outline-none focus:ring-2 focus:ring-primary/20" />
              <input placeholder="Lead email (optional)" aria-label="Lead email" value={edit.leadEmail} onChange={(e) => setEdit({ ...edit, leadEmail: e.target.value })} className="w-full bg-surface-container-high border-none rounded-lg px-4 py-2.5 text-body-md outline-none focus:ring-2 focus:ring-primary/20" />
            </div>
