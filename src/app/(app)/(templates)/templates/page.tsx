  ...
  return (
    <>
      ...
      <div className="bg-surface-container-lowest rounded-3xl border border-outline-variant/10 p-12 text-center">
        <span className="material-symbols-outlined text-5xl text-on-surface-variant/30 mb-4" aria-hidden="true">description</span>
        <h3 className="text-title-lg text-on-surface mb-2">No templates yet</h3>
        <p className="text-body-md text-on-surface-variant mb-6">Upload a PDF template or create one from scratch.</p>
